...
namespace WinUITestParser.Services
{
    public class XmlUtilService
    {
        ...
        public ValidationErrorModel ValidateXml(StorageFile file)
        {
        ...
        public ValidationErrorModel ValidateXml(string xml)
        {
            List<ValidationError> validateResult = new();
        ...
        public List<TransUnit> MapXmlToObject(string xml)
        {
        ...
        public string MapObjectToXml(List<TransUnit> transUnits)
        {
        ...
        public List<TransUnit> UpdateModel(List<TransUnit> origin, List<TransUnit> translate)
        {
